...
/**
 * How to sort HashMap in Java by keys and values. HashMap doesn't guarantee any
 * order, so you cannot rely on it, even if it appear that it storing entries in
 * a particular order, because it may not be available in future version e.g.
 * earlier HashMap stores integer keys on the order they are inserted but from
 * Java 8 it has changed.
 * 
 * @author WINDOWS 8
 */
